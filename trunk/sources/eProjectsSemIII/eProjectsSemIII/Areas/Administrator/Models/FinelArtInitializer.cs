...
namespace eProjectsSemIII.Models
{
    public class FinelArtInitializer : DropCreateDatabaseIfModelChanges<FineArtContext>
    {
        protected override void Seed(FineArtContext context)
        {
            ...
            {
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-05"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-1.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..." },
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-06"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-2.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..."},
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-07"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-3.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..."},
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-08"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-1.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..."},
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-09"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-2.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..." },
                new Competitions {Name="Pain", StartDate = DateTime.Parse("2008-09-10"), EndDate = DateTime.Parse("2007-09-10") ,Images="/Content/Images/competitions/competition-3.jpg",summary="The Gentletude Design Award is an international award for typhographic design students.The Award is run by the NGO Gentletude, a not-for-profit organization founded by Cristina Milani. he award aims is to encourage.Pink Lady Food Photographer of the Year is inspired by the proliferation of wonderful food photography in a huge variety of applications..." },
            ...
            {
                new Members {Username="minhphong137",Password="1371988", Name="Phong",Address="Ba ria vung tau",Phone="0128.66.01281",Gender="Male",Birthday=DateTime.Parse("1988-09-05"),Datejoin=DateTime.Parse("2008-09-05"),RoleID=1},
                new Members {Username="minhphong137",Password="1371988", Name="Son",Address="Tp.HCM",Phone="0128.66.01282",Gender="Male",Birthday=DateTime.Parse("1988-09-06"),Datejoin=DateTime.Parse("2008-09-05"),RoleID=2},
            ...
            {
                new Designs {Name = "Painting a Farm", Description="Paining a Farm", MemberID = 1, KindID = 1,CompetitionID=1,Mark=10,Remark=10,DatePost=DateTime.Parse("1988-09-06"),Images="/Content/Images/competitions/competition-1.jpg"},
                new Designs {Name = "Painting a Main", Description="Paining a main", MemberID = 1, KindID = 1,CompetitionID=1,Mark=10,Remark=9,DatePost=DateTime.Parse("1988-09-06"),Images="/Content/Images/competitions/competition-1.jpg"},
                new Designs {Name = "Painting a Family", Description="Paining a family", MemberID = 2, KindID = 2,CompetitionID=1,Mark=10,Remark=8,DatePost=DateTime.Parse("1988-09-06"),Images="/Content/Images/competitions/competition-1.jpg"},
                new Designs {Name = "Painting a World", Description="Paining a world", MemberID = 3, KindID = 3,CompetitionID=1,Mark=10,Remark=7,DatePost=DateTime.Parse("1988-09-06"),Images="/Content/Images/competitions/competition-1.jpg"},
                new Designs {Name = "Painting a Bar Coffee", Description="Paining a bar coffee", MemberID = 4, KindID = 4,CompetitionID=1,Mark=6,Remark=10,DatePost=DateTime.Parse("1988-09-06"),Images="/Content/Images/competitions/competition-1.jpg"},
